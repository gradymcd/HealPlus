			...
			if (args.length == 0) {
				...
				if (player.getServer().getPlayer(args[0]) != null) {
					...
					player.sendMessage(ChatColor.RED + "That player is not online!");
                		...
                		} if (commandLabel.equalsIgnoreCase("burnplus") || commandLabel.equalsIgnoreCase("bp") && player.hasPermission("hp.burn")) {
			if (args.length == 0) {
				...
				player.sendMessage(ChatColor.GREEN + "You have burned " + targetPlayer.getDisplayName() + "!");
				targetPlayer.sendMessage(ChatColor.LIGHT_PURPLE + "You have been burned by" + player.getDisplayName() + "!");
			} else if (args.length == 2) {
				if (player.getServer().getPlayer(args[0]) != null) {
					if (args[1].equalsIgnoreCase("1")){
						targetPlayer.setFireTicks(1);
					} else if (args[1].equalsIgnoreCase("2")){
						targetPlayer.setFireTicks(2);
					} else if (args[1].equalsIgnoreCase("3")){
						targetPlayer.setFireTicks(3);
					} else if (args[1].equalsIgnoreCase("4")){
						targetPlayer.setFireTicks(4);
					} else if (args[1].equalsIgnoreCase("5")){
						targetPlayer.setFireTicks(5);
					} else if (args[1].equalsIgnoreCase("6")){
						targetPlayer.setFireTicks(6);
					} else if (args[1].equalsIgnoreCase("7")){
						targetPlayer.setFireTicks(7);
					} else if (args[1].equalsIgnoreCase("8")){
						targetPlayer.setFireTicks(8);
					} else if (args[1].equalsIgnoreCase("9")){
						targetPlayer.setFireTicks(9);
					} else if (args[1].equalsIgnoreCase("10")){
						targetPlayer.setFireTicks(10);
					} else if (args[1].equalsIgnoreCase("11")){
						targetPlayer.setFireTicks(11);
					} else if (args[1].equalsIgnoreCase("12")){
						targetPlayer.setFireTicks(12);
					} else if (args[1].equalsIgnoreCase("13")){
						targetPlayer.setFireTicks(13);
					} else if (args[1].equalsIgnoreCase("14")){
						targetPlayer.setFireTicks(14);
					} else if (args[1].equalsIgnoreCase("15")){
						targetPlayer.setFireTicks(15);
					} else if (args[1].equalsIgnoreCase("16")){
						targetPlayer.setFireTicks(16);
					} else if (args[1].equalsIgnoreCase("17")){
						targetPlayer.setFireTicks(17);
					} else if (args[1].equalsIgnoreCase("18")){
						targetPlayer.setFireTicks(18);
					} else if (args[1].equalsIgnoreCase("19")){
						targetPlayer.setFireTicks(19);
					} else if (args[1].equalsIgnoreCase("20")){
